...
# Define base directory for resource loading
...
def run():
    ...
    img = Image.open(os.path.join(BASE_DIR, 'Logo', 'RESUM.png'))
    st.image(img)
    ...
    # Create the DB - SKIPPED IN POSTGRES (using neondb)
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            uploaded_resumes_dir = os.path.join(BASE_DIR, 'Uploaded_Resumes')
            if not os.path.exists(uploaded_resumes_dir):
                os.makedirs(uploaded_resumes_dir)
